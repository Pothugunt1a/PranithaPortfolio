  ...
  const projects = [
    {
      ...
      description: "Conducted multi-source data analysis using datasets from ICRISAT, Indian Weather Repository, and crop yield statistics, focusing on correlations between weather variability and agricultural output.",
      image: weatherDashboard,
      technologies: ["Python", "Pandas", "NumPy", "Google Data Studio", "Power BI", "D3.js", "VizHub", "Statistical Analysis"],
      achievements: [
    ...
    },
    {
      ...
      description: "Built a personalized movie recommendation system by analyzing large datasets from TMDB and IMDB, incorporating user reviews, metadata, and ratings using advanced NLP techniques.",
      image: movieRecommendation,
      technologies: ["Python", "Pandas", "NumPy", "TextBlob", "NLTK", "Beautiful Soup", "TF-IDF", "Cosine Similarity", "Machine Learning"],
      achievements: [
    ...
    },
    {
      ...
      description: "Designed a machine learning and image processing pipeline to accurately detect and segment water bodies from high-resolution satellite imagery using computer vision techniques.",
      image: waterDetection,
      technologies: ["Python", "OpenCV", "Machine Learning", "Image Processing", "HSV Color Space", "Canny Edge Detection", "Computer Vision"],
      achievements: [
      ...
      liveUrl: "https://example.com/water-detection"
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Showcasing my expertise in data analysis, machine learning, and full-stack development
            </p>
          </div>
