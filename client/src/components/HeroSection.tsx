...
export default function HeroSection({ scrollToSection }: HeroSectionProps) {
  ...
  const containerVariants = prefersReducedMotion ? getReducedMotionVariants(heroVariants) : heroVariants;
  const textVariants = prefersReducedMotion ? getReducedMotionVariants(heroTextVariants) : heroTextVariants;
  const imageVariants = prefersReducedMotion ? getReducedMotionVariants(heroImageVariants) : heroImageVariants;
  const buttonContainerVariants = prefersReducedMotion ? getReducedMotionVariants(staggerContainer) : staggerContainer;
  const buttonVariants = prefersReducedMotion ? getReducedMotionVariants(fadeUpVariants) : fadeUpVariants;
