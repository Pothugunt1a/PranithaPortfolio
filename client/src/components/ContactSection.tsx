...
import { Mail, Github, ExternalLink, Linkedin, Copy, Check, Globe, Database, BarChart3, Settings } from "lucide-react";
  ...
  const skills = [
    {
      ...
      description: "Modern web applications with React, Node.js, and TypeScript"
    },
    {
      icon: Database,
    ...
    },
    {
      ...
      description: "Transform data into actionable insights and compelling visuals"
    },
    {
      icon: Settings,
                    ...
                    {contact.isCopy ? (
                      ...
                      >
                        ...
                        <div className="flex-1 text-left">
                          ...
                          <p className="font-semibold text-base">{contact.value}</p>
                        </div>
                        {emailCopied && (
